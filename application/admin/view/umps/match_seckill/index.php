                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="match_name" lay-verify="match_name" style="width: 100%" autocomplete="off" placeholder="请输入产品名称,关键字,编号" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
...
<script>
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                var url=layList.U({c:'umps.match_seckill',a:'delete',q:{id:data.id}});
    ...
    layList.search('export',function(where){
        location.href=layList.U({c:'umps.match_seckill',a:'save_excel',q:{status:where.status,match_name:where.match_name}});
    })
    layList.switch('status',function (odj,value,name) {
        if (odj.elem.checked == true) {
            layList.baseGet(layList.Url({
                c: 'umps.match_seckill',
