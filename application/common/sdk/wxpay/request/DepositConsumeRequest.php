...
//支付押金（消费押金）
class DepositConsumeRequest extends Request
{
    use RequestTrait;
     ...
     * 设置押金总金额
     */
    public function setConsumeFee($amount)
    {
        $this->values['consume_fee'] = $amount;
        return $this;
    }
    /**
     * 设置押金总金额
     */
    public function setFeeType($amount)
    {
        $this->values['fee_type'] = $amount;
        return $this;
    }
